...
SET(CLAPACK_LIB_SEARCH_PATH	${CLAPACK_ROOT} ${CLAPACK_ROOT}/lib ${CLAPACK_ROOT}/F2CLIBS)
...
IF(CMAKE_SYSTEM_NAME STREQUAL Linux)
	FIND_LIBRARY(BLAS_LIBRARY blas_LINUX.a ${CLAPACK_LIB_SEARCH_PATH})
	FIND_LIBRARY(CLAPACK_LIBRARY lapack_LINUX.a ${CLAPACK_LIB_SEARCH_PATH})

	MESSAGE("Found ${BLAS_LIBRARY}")
	MESSAGE("Found ${CLAPACK_LIBRARY}")
ELSE()
	FIND_LIBRARY(BLAS_LIBRARY blas ${CLAPACK_LIB_SEARCH_PATH})
	FIND_LIBRARY(CLAPACK_LIBRARY lapack ${CLAPACK_LIB_SEARCH_PATH})
ENDIF()
FIND_LIBRARY(F2C_LIBRARY libf2c.a ${CLAPACK_LIB_SEARCH_PATH})
MESSAGE("Found ${F2C_LIBRARY}")

IF(BLAS_INCLUDE_PATH AND CLAPACK_INCLUDE_PATH AND F2C_INCLUDE_PATH AND BLAS_LIBRARY AND CLAPACK_LIBRARY AND F2C_LIBRARY)
	SET(CLAPACK_INCLUDE_DIR ${CLAPACK_INCLUDE_PATH} ${BLAS_INCLUDE_PATH} ${F2C_INCLUDE_PATH})
	SET(CLAPACK_LIBRARY ${CLAPACK_LIBRARY} ${BLAS_LIBRARY} ${F2C_LIBRARY})
